...
ibleaders.ibupload = {
    ...
    //uploadServerUrl: "http://upload.ibleaders.co.kr/jsp/ibupload.jsp|../../jsp/ibupload.jsp",

    //uploadServerUrl: "http://211.208.7.136:8080/resources/ib/jsp/ibupload.jsp",
    //downloadServerUrl: "http://211.208.7.136:8080/resources/ib/jsp/ibdownload.jsp",
    uploadServerUrl: "http://www.selltool.kr/resources/ib/jsp/ibupload.jsp",
    downloadServerUrl: "http://www.selltool.kr/resources/ib/jsp/ibdownload.jsp",
...
//    onUploadData: undefined,
    onUploadData: function(serverResponeObject, serverResponeText){
    	alert(serverResponeObject.etcdata.msg);
    	if(serverResponeObject.etcdata.code == '1'){
    		_BT.moveUrl(_BT.STORE.URL.Join.wait);
    	}else if(serverResponeObject.etcdata.code == '2'){
    		_BT.moveUrl(_BT.FRONT.URL.Site.Board);
    	}else if(serverResponeObject.etcdata.code == '3'){
    		_BT.moveUrl(_BT.FRONT.URL.Site.Promo);
    	}else if(serverResponeObject.etcdata.code == '4'){
    		_BT.moveUrl(_BT.FRONT.URL.Product.ItemDetailMng);
    	}else{
