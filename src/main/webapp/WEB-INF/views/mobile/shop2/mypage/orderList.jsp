	...
	<div class="section" style="min-height:700px;">
	 	<div class="tab_bar">
			<ul class="tab_list">
				...
				<li class="tab_item">
					<a href="javascript:;" class="tab_link" onclick="_BT.moveUrl(_BT.SHOP.URL.Order.OrderList);">
						<span id="tab2" class="tab<c:if test="${lnb.sId eq 2}"> tabOn</c:if>">반품/교환 신청</span>
					</a>
				</li>
				<li class="tab_item">
					<a href="javascript:;" class="tab_link" onclick="_BT.moveUrl(_BT.SHOP.URL.Order.OrderList);">
						<span id="tab3" class="tab<c:if test="${lnb.sId eq 3}"> tabOn</c:if>">반품/교환 현황</span>
					</a>
				</li>
				<li class="tab_item">
					<a href="javascript:;" class="tab_link" onclick="_BT.moveUrl(_BT.SHOP.URL.Order.OrderList);">
						<span id="tab4" class="tab<c:if test="${lnb.sId eq 4}"> tabOn</c:if>">교환/환불 관리</span>
					</a>
				</li>
			</ul>
		</div>
					...
					<tr>
						...
						<td style="padding:6px 0 0 30px;">
							...
							<span class="inquiry marginleft_30">
								<input type="text" class="input_style06" id="sDt" name="sDt" value=""/>
							</span>
							<span class="tbl_txt">
								~
							</span>
							<span class="inquiry">
								<input type="text" class="input_style06" id="eDt" name="eDt" value=""/>
							</span>
						</td>
					</tr>
					<tr>
			...
			<table class="cart_list margintop_20">
				...
				<tbody>
					...
					<c:if test="${fn:length(ordrList) le 0}">
						<tr>
							<td colspan="6" height="100px;">구매내역이 없습니다.</td>
						</tr>
					</c:if>	
