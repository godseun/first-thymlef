...
<%-- 									
										결제 금액<label class="price_color_red" style="padding-left: 10px;" id="payTotTxt"><fmt:formatNumber value="${ordrMst.TOTPRICE}" groupingUsed="true"/></label>원
										<br/>
 --%>										
										상품가격<label class="price_color" style="padding-left: 10px;" id="sumPriceTxt"><fmt:formatNumber value="${t_reAmt}" groupingUsed="true"/>원</label>
										<c:if test="${exDlvyFee gt 0 }">
											<span class="sumFee">
												<label class="icon"style="display: inline-block; padding: 0 5px;"><img src="${staticRoot}/img/icon_minus.jpg" alt="빼기" /></label>
												추가 배송비<label class="price_color" style="padding-left: 10px;" id="sumDlvyFeeTxt"><fmt:formatNumber value="${exDlvyFee}" groupingUsed="true"/></label>원
											</span>	
										</c:if>
										<span class="calFee vOff">
											<label class="icon"style="display: inline-block; padding: 0 5px;"><img src="${staticRoot}/img/icon_minus.jpg" alt="빼기" /></label>
											귀책 <c:out value="${jobTxt}"/>비<label class="price_color" style="padding-left: 10px;" id="calDlvyFeeTxt"></label>원
										</span>
										<span class="refFee vOff">
											<label class="icon"style="display: inline-block; padding: 0 5px;"><img src="${staticRoot}/img/icon_plus.jpg" alt="더하기" /></label>
											 환불배송비<label class="price_color" style="padding-left: 10px;" id="refFeeTxt"></label>원
										</span>
										<c:if test="${reDlvyFee gt 0 }">
											<label class="icon"style="display: inline-block; padding: 0 5px;"><img src="${staticRoot}/img/icon_plus.jpg" alt="더하기" /></label>
											 배송비<label class="price_color" style="padding-left: 10px;" id="refDlvyFeeTxt"><fmt:formatNumber value="${reDlvyFee}" groupingUsed="true"/></label>원
										</c:if>
										<label class="icon"style="display: inline-block; padding: 0 5px;"><img src="${staticRoot}/img/icon_equals.jpg" alt="합계" /></label>
										<c:out value="${jobTxt}"/> 예정금액<label class="price_color_red" style="padding-left: 10px;" id="sumTotTxt"><fmt:formatNumber value="${t_reAmt - exDlvyFee + reDlvyFee}" groupingUsed="true"/></label>원
				...
				<c:choose>
					<c:when test="${(t_reAmt - exDlvyFee + reDlvyFee) gt 0}">
						...
						<div class="return_select">
							<select class="" id="selRmk" name="selRmk" style="width: 100%;">
							...
							<input type="text" class="input_style14 margintop_10" id ="chrRmk" name="chrRmk" placeholder="상세내용 입력" style="width: 100%;">
						</div>
						<c:if test="${devy_done eq 'yes'}">
							<div class="signup_agree margintop_10">
