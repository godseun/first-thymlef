	...
	<div class="wid_1248 vOff" id="d02">
		...
		<div class="container">
			...
			<div class="section center_content">
				...
				<div class="signup_wrapper">
					대화 (이하 “회사” 라고 함) 은 통신비밀보호법, 전기통신사업법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보 취급방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.<br/><br/>
					...
					<기업/단체 회원가입 시><br/>
					-필수항목 : 아이디, 비밀번호, 이름(닉네임), 법인명 또는 상호명, 사업자등록번호, 대표자명, 업종, 이메일 주소, 사업장 소재지, 담당자 이름, 담당자 , 휴대 전화번호, 유선 전화번호<br/>
					-선택사항 : 설립일<br/>

					<제품 판매/구매 시><br/>
					-휴대 전화번호, 주소, 이메일, 신용카드 정보, 은행계좌 정보, 결제기록 등의 정보가 수집될 수 있습니다. 선택정보를 입력하지 않은 경우에도 서비스 이용 제한은 없으며 이용자의 기본적 인권 침해의 우려가 있는 민감한 개인 정보(인종, 사상 및 신조, 정치적 성향 이나 범죄기록, 의료정보 등)는 수집하지 않습니다.<br/><br/>
					...
					가. 기본 기능의 제공<br/>
					회사는 이용자의 전화번호 및 이용자의 전화기 내의 전화번호부에 저장되어 있는 제3자의 전화번호를 수집, 이용하여 자동 친구 등록 및 친구추천등과 같은 서비스를 제공합니다. 또한 이용자의 가입 시에 기기고유번호 (디바이스 아이디 또는 IMEI)를 수집하고 저장하여 이용자의 전화번호와 조합하여 개인식별을 위한 계정으로 사용하게 됩니다. 이용자 상태정보, 이용자 이름, 아이디, 사진은 이용자가 다른 이용자와의 소통과정에서 자신을 설명하기 위해 등록하는 정보로써 회원간에는 위 정보가 서로에게 공개됩니다.<br/><br/>
					...
					다. 회원관리<br/>
					회원제 서비스 이용 및 제한적 본인 확인제에 따른 본인확인, 개인식별, 불량회원(셀대화툴 이용약관 제 34조 위반 등으로 인하여 제 34조에 따른 영구이용정지 회원에 따라 계약 해지된 영구이용정지 회원)의 부정 이용방지와 비인가 사용방지, 가입의사 확인, 가입 및 가입횟수 제한, 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 추후 법정 대리인 본인확인, 분쟁 조정을 위한 기록보존, 불만처리 등 민원처리, 고지사항 전달<br/><br/>


					라. 신규 서비스 개발 및 마케팅ㆍ광고에의 활용<br/>
					신규 서비스 개발 및 맞춤 서비스 제공, 통계학적 특성에 따른 서비스 제공 및 광고 게재, 서비스의 유효성 확인, 이벤트 및 광고성 정보 제공 및 참여기회 제공, 접속빈도 파악, 회원의 서비스이용에 대한 통계<br/><br/>
					...
					가. 파기절차<br/>
					ㆍ이용자가 회원가입 등을 위해 입력한 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조)일정 기간 저장된 후 파기됩니다.<br/>
					...
					ㆍ이용자 혹은 만 14세 미만 아동의 개인정보 조회, 수정을 위해서는 서비스내 "내 프로필" 변경을, 가입 해지 (동의철회)를 위해서는 서비스내 "계정삭제"를 클릭하여 직접 열람, 정정 또는 탈퇴가 가능합니다.<br/><br/>
					...
					ㆍ이용자가 개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다. 또한 잘못된 개인정보를 제3 자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체 없이 통지하여 정정이 이루어지도록 하겠습니다.<br/>
					ㆍ회사는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 "5. 개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.<br/><br/>

					8. 개인정보 자동 수집 장치의 설치/운영 및 거부에 관한 사항<br/><br/>

					가. 개인정보 자동 수집 장치의 설치/운영<br/>
					회사는 계정정보를 생성하기 위해 이용자가 회사가 제공하는 서비스의 프로그램을 실행시 기기식별번호 (디바이스 아이디 또는 IMEI)를 자동으로 수집하게 됩니다. 또한 친구자동등록이나 친구추천 등의 기본기능을 제공하기 위하여 이용자의 전화기 내의 전화번호부에 저장되어 있는 제3자의 전화번호를 자동으로 수집하게 됩니다. 이용자가 기기식별번호를 자동으로 수집하는 것을 거부하는 경우 회사의 서비스를 이용할 수 없습니다. 이용자의 전화기 내의 전화 번호부에 저장되어 있는 제3자들의 전화번호를 회사가 수집,이용하는 것을 거부하는 이용자는 "설정" 메뉴에서 "자동친구등록"기능을 비활성화하는 방법으로 수집을 거부할수 있습니다. 다만, 이 경우 회사가 제공하는 서비스 중 특정 기능이 제대로 작동하지 않을수 있습니다.<br/><br/>

					나. 개인정보 자동 수집 거부<br/>
					회사는 이용자에게 특화된 맞춤서비스를 제공하기 위해서 이용자들의 정보를 수시로 저장하고 찾아내는 '쿠키(cookie)' 등을 운용합니다. 쿠키란 웹사이트를 운영하는데 이용되는 서버가 이용자의 브라우저에 보내는 아주 작은 텍스트 파일로서 이용자의 컴퓨터 하드디스크에 저장되기도 합니다. 회사는 다음과 같은 목적을 위해 쿠키를 사용합니다.<br/><br/>

					ㆍ쿠키 등 사용 목적<br/>
					회원과 비회원의 접속 빈도나 방문 시간 등을 분석, 이용자의 취향과 관심분야를 파악 및 자취 추적, 각종 이벤트 참여 정도 및 방문 회수 파악 등을 통한 타겟 마케팅 및 개인 맞춤 서비스 제공 이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서, 이용자는 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부할 수도 있습니다.<br/><br/>
					...
					회사는 이용자들의 개인정보를 취급함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성확보를 위하여 다음과 같은 기술적/관리적 대책을 강구하고 있습니다.<br/><br/>

					가. 해킹 등에 대비한 대책<br/>
					회사는 해킹이나 컴퓨터 바이러스 등에 의해 회원의 개인정보가 유출되거나 훼손되는 것을 막기 위해 최선을 다하고 있습니다. 개인정보의 훼손에 대비해서 자료를 수시로 백업하고 있고, 최신 백신프로그램을 이용하여 이용자들의 개인정보나 자료가 누출되거나 손상되지 않도록 방지하고 있으며, 암호화통신 등을 통하여 네트워크상에서 개인정보를 안전하게 전송할 수 있도록하고 있습니다. 그리고 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있으며, 기타 시스템적으로 보안성을 확보하기 위한 가능한 모든 기술적 장치를 갖추려 노력하고 있습니다.<br/><br/>

					나. 취급 직원의 최소화 및 교육<br/>
					회사의 개인정보관련 취급 직원은 담당자에 한정시키고 있고 이를 위한 별도의 비밀번호를 부여하여 정기적으로 갱신하고 있으며, 담당자에 대한 수시 교육을 통하여 회사는 개인정보취급방침의 준수를 항상 강조하고 있습니다.<br/><br/>

					다. 개인정보보호전담기구의 운영<br/>
					그리고 사내 개인정보보호전담기구 등을 통하여 회사는 개인정보취급방침의 이행사항 및 담당자의 준수여부를 확인하여 문제가 발견될 경우 즉시 수정하고 바로 잡을 수 있도록 노력하고 있습니다. 단, 이용자 본인의 부주의나 인터넷상의 문제로 개인 정보가 유출되어 발생한 문제에 대해 회사는 일체의 책임을 지지 않습니다.<br/><br/>
