...
<c:choose>
						...
						<img src="<c:out value="${prdt2.PRDT_IMG}"/>" alt="상품사진" style="width:auto;height:160px; max-width:200px;" onerror="this.src='${staticRoot}/img/sample03.jpg'"/> 
</c:when>
						<c:otherwise>
							<img src="${upload}<c:out value="${prdt2.PRDT_IMG}"/>" alt="상품사진" style="width:auto;height:160px; max-width:200px;" onerror="this.src='${staticRoot}/img/sample03.jpg'"/> 
	</c:otherwise>
						</c:choose>
						</a>
					</div>
