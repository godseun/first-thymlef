		...
		function fnNextStep() {
			if(_BT.isEmpty($("#usrNm").val())){
				...
				return false;
					...
					alert("인증하기 버튼을 눌러 휴대폰 인증을 완료해 주세요.");
					return false;
			}else{
							...
							<tbody>
								<tr>
									...
									<td>
										...
										<br/>
										<br/>
										<input type="text" name="mobile2" id="mobile2" class="join_form_input01 mobile" maxlength="4" size="4" style="min-width:70px;"/>
										<span class="join_form_txt">-</span>
										<input type="text" name="mobile3" id="mobile3" class="join_form_input01 mobile" maxlength="4" size="4" style="min-width:70px;"/>
										...
										<span class="vOff margintop_5" id = "authSpan">
											<input type="text" name="authNo" id="authNo" class="join_form_input03" placeholder="6자리 인증번호" maxlength="6" size="6" />
