...
<%@ include file="/WEB-INF/views/common/layout/include/base.jsp" %>
	<script type="text/javascript">
		...
		<div class="" >
			...
			<form id="tmpFrm" name="tmpFrm">
				...
				<div class="c13_01_02_box_02 d60"  style="display: none;">
					...
					<div class="margintop_20">
						<span class="c13_01_02_txt_02" style="margin-right:35px;">규 격</span>
						<span><input class="input_style07 paddingleft_10" placeholder="제품규격을 입력해주세요." id="stndrd" name="stndrd" type="text" style="width:65%;"></span>
					</div>
					<div class="margintop_5">
						<span class="c13_01_02_txt_02" style="margin-right:12px;">모델번호</span>
						<span><input class="input_style07 paddingleft_10" placeholder="모델번호를 입력해주세요." id="modelNm" name="modelNm" type="text" style="width:65%;"></span>
					</div>
					<div class="margintop_5">
						<span class="c13_01_02_txt_02" style="margin-right:26px;">제조사</span>
						<span><input class="input_style07 paddingleft_10" placeholder="제조사를 입력해주세요." id="makrNm" name="makrNm" type="text" style="width:65%;"></span>
					</div>
					<div class="margintop_5">
						<span class="c13_01_02_txt_02" style="margin-right:26px;">재고량</span>
						<span><input class="input_style07 number paddingleft_10" placeholder="재고량을 입력해주세요." id="amt" name="amt" type="text" style="width:65%;"></span>
					</div>
					<div class="margintop_5 marginbottom_20">
						<span class="c13_01_02_txt_02" style="margin-right:12px;">판매가격</span>
						<span><input class="input_style07 number paddingleft_10" placeholder="희망 판매가격을 입력해주세요." id="price" name="price" type="text" style="width:65%;"></span>
					</div>
				...
				<div class="c13_01_02_box_04 d80"  style="display: none;">
					...
					<div class="c13_01_02_check_01" style="text-align:center;">
						...
						<input id="del_fee" name="del_fee" class="input_style05 number" style="margin-left: 20px;" placeholder="배송비" type="text">
					</div>					
					<div class="c13_01_02_check_02" style="text-align:center ;">
						...
						<input id="freeYn" name="freeYn" value="1" type="checkbox" class="chk" style="margin-bottom: 12px; margin-left: 10px;"/>
			...
			<div class="c13_01_02_box_05 d90 hMouse" style=" margin-bottom: 100px;display: none;" >
				<span class="c13_01_02_txt_01">추가사진을 촬영해 주세요. ( 최대4장 )</span>
				<div class="c13_01_02_img_01" id="sDiv">
					<img src="${staticRoot}/img/c13_01_02_noimg_02.jpg" id="sResult0" width="120px" height="100px" alt="사진선택" class="sResult"/>
					<img src="${staticRoot}/img/c13_01_02_noimg_02.jpg" id="sResult1" width="120px" height="100px" alt="사진선택" class="sResult marginleft_10"/>
					<img src="${staticRoot}/img/c13_01_02_noimg_02.jpg" id="sResult2" width="120px" height="100px" alt="사진선택" class="sResult"/>
					<img src="${staticRoot}/img/c13_01_02_noimg_02.jpg" id="sResult3" width="120px" height="100px" alt="사진선택" class="sResult marginleft_10" />
				</div>			
				<label class="click_btn05 margintop_10" onclick="fnSave();">저장</label>
			</div>

			<!-- 하단 완료게이지-->
			<div class="c13_01_02_box_09" style="position:fixed;bottom:0;z-index:900;width:100%;height:50px;">
				<span class="c13_01_02_bar_on_1 bar_off p50"></span>
				<span class="c13_01_02_bar_on_1 bar_off p50"></span>
				<span class="c13_01_02_bar_on_1 bar_off p50"></span>
				<span class="c13_01_02_bar_on_1 bar_off p50"></span>
				<span class="c13_01_02_bar_on_1 bar_off p50"></span>
				<span class="c13_01_02_bar_on_1 bar_off p60"></span>
				<span class="c13_01_02_bar_on_1 bar_off p70"></span>
				<span class="c13_01_02_bar_on_1 bar_off p80"></span>
				<span class="c13_01_02_bar_on_1 bar_off p90"></span>
				<span class="c13_01_02_bar_on_1 bar_off p100"></span>
				<span class="c13_01_02_txt_03" id ="proc" style="margin-left: 10px;">0</span><span class="c13_01_02_txt_03">%</span>
			</div>
			<!-- 하단 완료게이지-->
		</div>