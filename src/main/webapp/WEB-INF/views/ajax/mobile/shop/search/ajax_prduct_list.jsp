				...
				<c:forEach items="${result.resultList}" var="prdt1" varStatus="status">
					...
					<div class="mItem recommend_con_Type02 <c:if test="${status.count%2 ne '0'}"> mg_10</c:if>" data-type="<c:out value="${prdt1.PRDT_CD}"/>" style="width: 47%;">
						<div class="recommend_con_img01" align="center" style="overflow: hidden;">
							<a href="#" class="img">
								<img src="${upload}<c:out value="${prdt1.PRDT_IMG}"/>" alt="상품사진" style="width:auto;height:150px; max-width:200px;" onerror="this.src='${staticRoot}/img/sample03.jpg'"/> 
							</a>
						</div>
		...
		<c:otherwise>
			...
			<article class="search_detail_prduct_data">
				<c:forEach items="${result.resultList}" var="prdt2" varStatus="status">
					<div class="mItem recommend_con_Type02 <c:if test="${status.count%2 ne '0'}"> mg_10</c:if>" data-type="<c:out value="${prdt2.PRDT_CD}"/>" style="width: 47%;">
						<div class="recommend_con_img01" align="center" style="overflow: hidden;">
							<a href="#" class="img">
								<img src="${upload}<c:out value="${prdt2.PRDT_IMG}"/>" alt="상품사진" style="width:auto;height:150px; max-width:200px;" onerror="this.src='${staticRoot}/img/sample03.jpg'"/> 
							</a>
						</div>
						<div class="recommend_con_txt01">
							<h2 class="title01" style="text-align: left;">
