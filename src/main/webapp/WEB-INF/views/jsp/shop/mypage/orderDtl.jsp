					...
					<tr>
						...
						<td>
							<c:choose>
								...
								<c:otherwise>
									 상품가격<label class="price_color">0</label>원
									<label class="icon">
										<img src="${staticRoot}/img/icon_plus.jpg" alt="플러스">
									</label>
									배송비<label class="price_color">0</label>원
								</c:otherwise>
							</c:choose>
						</td>
					</tr>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<input type="text" class="join_form_input03 5 inAddr" id="dtlAddress" name="dtlAddress"  placeholder="상세주소" value="<c:out value="${ordrMst.ADDRESS_DETAIL}"/>"/>	
									</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										...
										<input type="text" class="join_form_input01 mobile inAddr" id="mobile1" maxlength="4" value="${fn:split(ordrMst.TEL_NO,'-')[0]}"/>
											<span class="join_form_txt">-</span>
										<input type="text" class="join_form_input01 mobile inAddr" id="mobile2" maxlength="4" value="${fn:split(ordrMst.TEL_NO,'-')[1]}"/>
											<span class="join_form_txt">-</span>
										<input type="text" class="join_form_input01 mobile inAddr" id="mobile3" maxlength="4" value="${fn:split(ordrMst.TEL_NO,'-')[2]}"/>
									</td>
								</tr>
								<tr>
									<th>
