	...
	<div class="section" style="min-height: 1000px;">
		...
		<div class="notcie_board">
			<c:forEach items="${prmList}" var="prm" varStatus="status">
				<div class="notcie_board0 prmBar" id="<c:out value="${prm.PROMO_ID}"/>" style="margin: 2px 2px; padding: 2px 2px;text-align: center;">
					<a href="javascript:;">
						<img alt="광고배너" src="${upload}/<c:out value="${prm.DETAIL_IMG}"/>" style="width:305px;height:auto;">
					</a>
				</div>
			</c:forEach>
		</div>
