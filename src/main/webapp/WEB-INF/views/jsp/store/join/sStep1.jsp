							...
							<table class="join_form">
								...
								<tbody>
									<tr>
										...
										<td colspan="3">
											<input type="text" class="join_form_input01" id="busiNo1" name="busiNo1" maxlength="3" placeholder="3자리 숫자"/><span class="join_form_txt">-</span>
											<input type="text" class="join_form_input01" id="busiNo2" name="busiNo2" maxlength="2" placeholder="2자리 숫자"/><span class="join_form_txt">-</span>
											<input type="text" class="join_form_input01" id="busiNo3" name="busiNo3" maxlength="5" placeholder="5자리 숫자"/><span class="join_form_btn" id="chBusiNo" onclick="fnBusiNo();">중복확인</span><br>
