<%@page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ include file="/WEB-INF/views/common/layout/include/base.jsp" %>
				...
				_BT.ajaxCallbackSubmit("frm", _BT.SHOP.URL.Common.doLogin, function (data) {
					if ($(data).size() > 0) {
						if (_BT.isEquals(data.code, "success")) {
							_BT.moveUrl(_BT.STORE.URL.Common.Main);
							return false;
		...
		<div class="section2" style="text-align: center;min-height: 440px;">
			<div style="width: 460px; margin: auto; text-align: center;">
				<h1 class="blue_title" style="margin-top:100px;text-align: center;">
					대화 파트너 센터 로그인
				</h1>
				<div class="store_substance margintop_40">
					...
					<div class="btn_content01 margintop_40 marginbottom_30">
						<%-- <span id="btnNext" onclick="_BT.moveUrl(_BT.STORE.URL.Join.sStep1);" class="bOn">
							입점하기
							</span>
							--%>
