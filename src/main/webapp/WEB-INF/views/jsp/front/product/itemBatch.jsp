 ...
 */					
					...
					,{'Header': '상품이미지',	'Type': 'Text',	 		'MinWidth': 150, 	'SaveName': 'PRDT_IMG',			'Align': 'Left',		'Save': 1,		'Edit':1, 		'KeyField':1}
...
<%-- 													
 ...
 --%>
		...
		<h1 class="title_con_Type02 margintop_20">
			...
			<span data-type="noSale" data-value="2"  class="sButton btn_span fs-13 pink marginleft_5" style="float: right;">단종</span>
			<span data-type="soldOut" data-value="2"  class="sButton btn_span fs-13 green marginleft_5" style="float: right;">일시품절</span>
			<span data-type="onSale" data-value="2"  class="sButton btn_span fs-13 blue marginleft_5" style="float: right;">판매가능</span>
		</h1>	
		<div class='col-sm-5 col-md-5' style='width: 100%; height: 410px; display: block;padding-top:5px;'>
