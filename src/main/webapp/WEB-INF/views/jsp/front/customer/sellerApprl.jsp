	...
	<script type="text/javascript">
		...
		function initSheet(){
			...
			initData.Cols = [
				...
				,{'Header': '첨부|첨부',					'Type': 'Popup',		'MinWidth': 80,		'SaveName': 'sBslImg', 			'Align': 'Center',	'Edit':1,	'Save': 0,	'ColMerge':0	}
				,{'Header': '설정|승인', 				'Type': 'Combo',		'MinWidth': 60, 	'SaveName': 'sSttus', 			'Align': 'Center',	'Edit':1,	'Save': 1	, 	'ColMerge':0,	'ComboText': '가입|승인|미승인', 	'ComboCode': '0|1|9' }  
				,{'Header': '설정|ERP구분', 			'Type': 'Combo', 		'MinWidth': 60, 	'SaveName': 'sErpLv',		 		'Align': 'Center',	'Edit':1,	'Save': 1	, 	'ColMerge':0,	'ComboText': '프리|프라임', 		'ComboCode': '1|2' }  
				...
				,{'Header': '기본정보|상점명', 			'Type': 'Text', 			'MinWidth': 70, 	'SaveName': 'sStoreNm', 		'Align': 'Center',	'Edit':0,	'Save': 0	, 	'ColMerge':0	}
				,{'Header': '기본정보|상호명', 			'Type': 'Text', 			'MinWidth': 70, 	'SaveName': 'sCmpNm',	 		'Align': 'Center',	'Edit':1,	'Save': 1	, 	'ColMerge':0	}
				,{'Header': '기본정보|사업자번호', 		'Type': 'Text', 			'MinWidth': 90, 	'SaveName': 'sCmpBizNo',		'Align': 'Center',	'Edit':1,	'Save': 1	, 	'ColMerge':0	}
			...
			createIBSheet2(container, 'mySheet1', '100%', '350px');
			...
			createIBSheet2(container2, 'mySheet2', '100%', '350px');
			// IBSheet 초기화
		...
		function doAction(sAction, tar) { 
			switch(sAction) {     
				case 'search':            
					...
					if(1 == tar)
						sheet.DoSearch(_BT.FRONT.URL.Search.SheetStoreList, $('#sheetFrm').serialize()); 
					else if(2 == tar)
						sheet.DoSearch(_BT.FRONT.URL.Search.SheetContList, $('#sheetFrm2').serialize()); 
					break; 
				case 'insert':       //입력
						...
						<tr>
							...
							<td style="text-align: left;">
								...
								<span class="inquiry_btn marginleft_7">
									<span data-type="save" data-value="1" class="sButton btn_span fs-13 pink marginleft_5" style="float: right;">변경</span>
									<span data-type="conf" data-value="1" class="sButton btn_span fs-13 green marginleft_5" style="float: right;">승인</span>
